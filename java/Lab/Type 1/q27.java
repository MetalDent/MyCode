...
class q27{
   ...
   if( d == 0 )
     System.out.println("This matrix is not invertible as the determinant is zero");
   else
      System.out.println("This matrix is invertible as the determinant is not zero");
